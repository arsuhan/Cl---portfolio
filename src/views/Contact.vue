...
const WEB3FORMS_ACCESS_KEY = 'f5dcfd60-8200-4087-862d-8d457546b6ed'
const name = ref('')
const email = ref('')
const message = ref('')
...
<div class="space-x-2 mt-2 md:mt-16">
  ...
  <h2 class="lg:text-3xl xs:text-xl xs:mx-1 lg:items-start lg:justify-start font-bold mb-4 lg:mx-6 text-white xs:-mt-6 md:justify-start">Contact Information</h2>
  ...
  <div class="lg:space-y-10 xs:space-y-6">
    ...
    <div class="flex items-start -mt-2 lg:mx-4 lg:-mt-4 xs:-mx-4">
      <div class="p-3 lg:rounded-sm xs:rounded-xl text-white mt-1.5">
        <svg
          class="lg:w-10 lg:h-10 md:w-10 md:h-10 xs:w-8 xs:h-8"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <div class="xs:-mt- lg:mx-2 ">
        ...
        <p class="text-white mx-2">iamsohan11@gmail.com</p>
      </div>
    </div>
    <div class="flex items-start lg:mx-6 xs:-mx-4">
      <div class="p-3 lg:rounded-sm xs:rounded-xl text-white lg:-mt-2 xs:-mt-1.5">
        <svg
          class="lg:w-10 lg:h-10 md:w-10 md:h-10 xs:w-8 xs:h-8"
          fill="currentColor"
          viewBox="0 0 24 24"
      ...
      <div class="xs:-mt-1 lg:mx-2">
        ...
        <p class="text-white mx-2">+880 1327 2926 90</p>
      </div>
    </div>
...
<div class="flex space-x-8 xs:mt-10 lg:mt-19 xs:mx-3 lg:mx-12 md:mt-6">
  <a href="https://github.com/MrSohan10"
              target="_blank"
              class="text-cyan-400 border-cyan-400 hover:shadow-cyan-400 hover:text-cyan-400 border duration-500 hover:-translate-y-1.5 p-2.5 rounded-xl transition hover:shadow-[0_0_15px_rgba(0,0,0,0.4)]"
            >
              <svg
                class="w-6 h-6"
                fill="currentColor"
    ...
    <a href="https://www.linkedin.com/in/md-sabbir-ahmed-sohan/"
              target="_blank"
              class="text-cyan-400 border-cyan-400 hover:shadow-cyan-400 hover:text-cyan-400 border duration-500 hover:-translate-y-1.5 p-3 rounded-xl transition hover:shadow-[0_0_15px_rgba(0,0,0,0.4)]"
            >
