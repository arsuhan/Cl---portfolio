<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <a href="https://www.linkedin.com/in/md-sabbir-ahmed-sohan/" target="_blank" class="text-cyan-400 border-cyan-400 hover:shadow-cyan-400 hover:text-cyan-400 border duration-500 hover:-translate-y-1.5 p-2 rounded-full  transition hover:shadow-[0_0_15px_rgba(0,0,0,0.4)]">
          ...
          <div class="flex justify-center lg:justify-start">
            ...
            >
              <button
                class="w-48 md:w-52 lg:w-52 px-4 lg:px-8 py-2 md:py-3 text-black hover:shadow-cyan-400 bg-[#00f0ff] rounded-full font-medium duration-500 transition hover:shadow-[0_0_15px_rgba(0,0,0,0.4)]hover:shadow-cyan-400"
              >
                Download CV
              </button>
            </a>
      ...
      <div
         class="overflow-hidden rounded-full relative z-10 w-full max-w-[350px] bg-cyan-400 ring-4 dark:ring-cyan-400 ring-cyan-400 shadow-[0_0_25px_rgba(0,0,0,0.4)] shadow-cyan-400"
        >
        <img
